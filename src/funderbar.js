...
_.increment = function(a){
  ...
  return ++a;
  // for the increment operator, if you add ++ after it and are
  // trying to return that, it'll return the value FIRST, then
  // try incremeneting it (doesn't work); to get around this,
  // move the increment operator in front of the variable
}
...
_.decrement = function(a){
  ...
  return --a;
  // this works exactly the same as the increment operator, as
  // described on lines 70-73
}
